	...
	<body class="hold-transition sidebar-mini">
		...
		<div class="wrapper">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
							<img src="/storage/{{Auth::guard('admin')->user()->image}}" class='img-circle elevation-2' width="40" height="40" alt="">
						</a>
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							<h4 class="h4 mb-0"><strong>{{ Auth::guard('admin')->user()->full_name }}</strong></h4>
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; 2024-2029 Furever Family Finder All rights reserved.
			</footer>
