...
<div class="hero">
    <div class="relative">
      ...
      <div
        ...
        <p class="text-center font-bold text-[#515252] md:text-2xl md:mt-5">Welcome {{Auth::guard('adaptor')->user()->full_name}}</p>
        <p class="text-center text-sm md:text-lg text-[#515252]">Every Pet Deserves a Good Home. #FureverFamilyFinder
        </p>
        <button
          class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-6 md:mx-20 rounded-full mt-10 md:my-auto hidden md:block"><a href="{{route('adaptor-avliablepets')}}">Adopt A Pet</a></button>
    ...
    <div class="phase-4 relative">
      ...
      <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
        ...
        <button class="h-10 w-40 border rounded-full bg-white text-black font-bold hover:bg-orange-600 focus:bg-orange-600 transition-colors duration-300 mt-10">
          <a href="{{route('adaptor-avliablepets')}}">Adopt A Pet</a>
        </button>
      </div>
    </div>
    </div>
