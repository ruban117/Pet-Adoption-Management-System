...
@section('title_nm','Adaptor::Update Pet')
...
<h1 class="text-2xl font-bold text-[#515279] text-center mt-5">Update Pet</h1>
...
<form action="{{route('update-adaptor-pet-image',$pets->p_id)}}" class="flex flex-col items-start justify-center px-8 mt-8 space-y-7 md:px-72" enctype="multipart/form-data" method="POST">
    <a href="{{route('show-adaptor-pet',$pets->p_id)}}" class="font-bold text-blue-500">Back</a>
    @csrf
...
<form action="{{route('update-adaptor-pet-certificate',$pets->p_id)}}" class="flex flex-col items-start justify-center px-8 mt-8 space-y-7 md:px-72" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="image space-y-4 flex flex-col">
...
<form action="{{route('update-adaptor-pet-form',$pets->p_id)}}" class="flex flex-col items-start justify-center px-8 mt-8 space-y-7 md:px-72" enctype="multipart/form-data" method="POST">
